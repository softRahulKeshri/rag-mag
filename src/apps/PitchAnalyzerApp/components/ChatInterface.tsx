          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {currentPitches.map((pitch) => (
                <div
                  key={pitch.id}
                  className="pitch-card bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-all duration-200"
                >
                  ...
                  <div className="pitch-card-content">
                    ...
                    <div className="pitch-card-spacer"></div>
                    ...
                    <div className="pitch-card-buttons flex flex-col space-y-2">
                      {/* Primary Chat Button */}
                      <button
                        onClick={() => handlePitchSelect(pitch)}
                        className="pitch-card-button w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl font-medium"
                      >
                        <ChatBubbleLeftRightIcon className="w-5 h-5 mr-2 flex-shrink-0" />
                        <span className="pitch-card-button-text">
                          Start AI Chat
                        </span>
                      </button>
                      ...
                      <button
                        ...
                        className="pitch-card-button w-full inline-flex items-center justify-center px-3 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-all duration-200 font-medium"
                        title="View Details"
                      >
                        <svg
