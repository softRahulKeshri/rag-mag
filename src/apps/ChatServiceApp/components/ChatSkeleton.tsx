...
export const ChatLoadingState: React.FC<ChatLoadingStateProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 ${className}`}
    >
      ...
      <div className="relative max-w-md w-full mx-auto p-8">
        ...
        <div className="relative z-10 flex flex-col items-center space-y-8">
          ...
          <div className="relative">
            {/* Outer glow ring */}
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-400/20 via-purple-400/20 to-indigo-400/20 rounded-full blur-xl animate-pulse" />

            {/* Main logo container */}
            <div className="relative w-20 h-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-2xl border border-white/20">
              {/* Animated icon */}
              <div className="relative">
                <svg
                ...
                {/* Floating particles */}
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-emerald-400 rounded-full animate-bounce border-2 border-white shadow-lg" />
                <div
                  className="absolute -bottom-1 -left-1 w-2 h-2 bg-pink-400 rounded-full animate-bounce border-2 border-white shadow-lg"
                  style={{ animationDelay: "0.2s" }}
                />
              </div>
            </div>
            ...
            <div
              className="absolute -inset-2 bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-indigo-500/30 rounded-2xl animate-spin"
          ...
          <div className="w-full max-w-xs">
            <div className="relative">
              ...
              {/* Floating dots */}
              <div className="absolute -top-1 left-1/4 w-4 h-4 bg-blue-500 rounded-full animate-bounce shadow-lg" />
              <div
                className="absolute -top-1 left-1/2 w-4 h-4 bg-purple-500 rounded-full animate-bounce shadow-lg"
                style={{ animationDelay: "0.3s" }}
              />
              <div
                className="absolute -top-1 left-3/4 w-4 h-4 bg-indigo-500 rounded-full animate-bounce shadow-lg"
          ...
          <div
            className="absolute bottom-4 left-4 w-3 h-3 bg-purple-400/60 rounded-full animate-ping"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 left-4 w-1 h-1 bg-indigo-400/60 rounded-full animate-ping"
